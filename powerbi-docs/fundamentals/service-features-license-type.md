...
To learn more about the capabilities your license provides, see [Feature availability for users with free licenses](../explore-reports/end-user-features.md) and [Types of licenses for Power BI consumers](end-user-license.md).
