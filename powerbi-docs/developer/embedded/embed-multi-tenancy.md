...
* Grant [access permissions](/power-bi/explore-reports/end-user-workspaces#permissions-in-the-workspaces) to the workspace. The service principal profile must have *Admin* access to the workspace.
...
Read more about [Power BI workspaces](/power-bi/explore-reports/end-user-workspaces).
