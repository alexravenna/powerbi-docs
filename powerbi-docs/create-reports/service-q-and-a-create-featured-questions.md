...
- You just need a [Fabric free license](../explore-reports/end-user-features.md) to add featured questions to a dataset in My Workspace in the Power BI service.
