...
- Analyze in Excel and Export with live connection are not supported for Power BI report server or Power BI Embed for your customer (app owns data) scenario.
